...
public class GameActivity_78 extends AppCompatActivity {
    ...
    private void alert(String playerName) {
        ...
        final int p1score = (board1.turn == Board_78.Turn.FIRST) ? ( getPlayerOneScore() + 1 ) : getPlayerOneScore() ;
        final int p2score = (board1.turn == Board_78.Turn.FIRST) ? getPlayerTwoScore() : ( getPlayerTwoScore() + 1 ) ;
        String title = "";
        String print = "";
        ...
        alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int i) {
                ...
                if (getNumberRounds() > 1) {
                    Intent myIntent = new Intent(GameActivity_78.this, GameActivity_78.class);
                    ...
                    Intent myIntent = new Intent(GameActivity_78.this, Choose_Name_2P.class);
                    startActivity(myIntent);
                }
            }
        });
