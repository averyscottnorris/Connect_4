...
/*
 *
 * Created by kavinarasu on 3/3/18.
 */
...
public class Board_sp {
    private static final String TAG = "player 1";
     ...
     */
    public Board_sp(@NonNull int[][] grid, int[] free) {
        mGrid = grid;
        numRows = grid.length;
    ...
    public Outcome checkWin() {
        ...
        if (horizontalCheck() || verticalCheck() ||
            ...
            return mCellValue == cell_sp.PLAYER1 ? Outcome.PLAYER1_WINS : Outcome.PLAYER2_WINS;
        }
