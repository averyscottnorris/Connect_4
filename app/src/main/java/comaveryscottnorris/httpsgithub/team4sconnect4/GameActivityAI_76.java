...
import comaveryscottnorris.httpsgithub.team4sconnect4.Choose_Name_2P;
import comaveryscottnorris.httpsgithub.team4sconnect4.R;

public class GameActivityAI_76 extends Activity {
    ...
    public static final String TAG = "GameActivityAI_76";
    public static final int[][] gridBoard = new int[NUM_ROWS][NUM_COLS];
    ...
    private void alert(String playerName) {
        ...
        alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int i) {
                ...
                if (getNumberRounds() > 1) {
                    Intent myIntent = new Intent(GameActivityAI_76.this, GameActivityAI_76.class);
                    ...
                    Intent myIntent = new Intent(GameActivityAI_76.this, Choose_Name_2P.class);
                    startActivity(myIntent);
                }
            }
        });
    ...
    public static boolean countermatch(int columnA, int rowA, int columnB, int rowB) {
        // return false if either set of coordinates falls out of bounds
        if (columnA < 0 || columnA >= NUM_COLS
                || rowA < 0 || rowA >= NUM_ROWS
                || columnB < 0 || columnB >= NUM_COLS
                || rowB < 0 || rowB >= NUM_ROWS) {
            return false;
        }
        return !(gridBoard[rowA][columnA] == 0 || gridBoard[rowB][columnB] == 0) && gridBoard[rowA][columnA] == gridBoard[rowB][columnB];
    }
